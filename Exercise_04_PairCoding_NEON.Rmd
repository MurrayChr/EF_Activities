...
1. Pull the latest code from Github. In RStudio this is done by clicking the light blue down arrow on the Git tab. This is equivalent to the commandline _git pull origin main_ where origin refers to where the where you did your orginal clone from and main refers to your main branch (if you use branches you can pull other branches)
